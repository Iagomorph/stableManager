              ...
              FutureBuilder(
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  ...
                  if (snapshot.hasData) {
                                  ...
                                  children: [
                                    Column(
                                      children: [
                                        ...
                                        Text("robe : " +
                                            snapshot.data[index].robe),
                                        Text("sexe : " +
                                            snapshot.data[index].sexe)
                                      ],
                                    ),
                                    Column(
                                      children: [
                                    ...
                                    ElevatedButton(
                                        onPressed: () {
                                          ...
                                          horseSexeController.value =
                                              TextEditingValue(
                                                  text: snapshot
                                                      .data[index].sexe);
                                          horseAgeController.value =
                                              TextEditingValue(
                                                  text: snapshot.data[index].age
                                                      .toString());
                                          horseRobeController.value =
                                              TextEditingValue(
                                                  text: snapshot
                                                      .data[index].robe);
                                          horseImgController.value =
                                              TextEditingValue(
                                                  text: snapshot
                                                      .data[index].image);
                                          horseRaceController.value =
                                              TextEditingValue(
                                                  text: snapshot
                                                      .data[index].race);
                                          showDialog(
                                                  ...
                                                  children: [
                                                    ...
                                                    TextFormField(
                                                      decoration: const InputDecoration(
                                                          ...
                                                          labelText: "photo",
                                                          hintText:
                                                              "Entrez une photo de votre cheval"),
                                                      controller:
                                                          horseImgController,
                                                    ),
                                                    TextFormField(
                                                    ...
                                                    TextFormField(
                                                      decoration: const InputDecoration(
                                                          ...
                                                          labelText: "robe",
                                                          hintText:
                                                              "Entrez la couleur de la robe de votre cheval"),
                                                      controller:
                                                          horseRobeController,
                                                    ),
                                                    TextFormField(
                                                      decoration: const InputDecoration(
                                                          ...
                                                          labelText: "race",
                                                          hintText:
                                                              "Entrez la race de votre cheval"),
                                                      controller:
                                                          horseRaceController,
                                                    ),
                                                    TextFormField(
                                                      decoration: const InputDecoration(
                                                          ...
                                                          labelText: "sexe",
                                                          hintText:
                                                              "Entrez le sexe de votre cheval"),
                                                      controller:
                                                          horseSexeController,
                                                    ),
                                                    ...
                                                    ElevatedButton(
                                                        ...
                                                        child: Text(
                                                            "Modifier les infos de votre cheval"))
                                                  ],
                                                )));
                                              });
                                        },
                    ...
                    return const Center(child: Text("no data avaible"));
                  }
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                    onPressed: () async {
                                      ...
                                      int age =
                                          int.parse(horseAgeController.text);
                                      ...
                                      Horse horse = Horse(uid, img, name, age,
                                          robe, race, sexe, spec);
