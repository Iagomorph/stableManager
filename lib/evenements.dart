            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const EvenementsForm()),
                );
              },
            )
          ],
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Visibility(
                                        visible:
                                        _orgaBool(snapshot.data[index].type),
                                        child: Text(
                                          'Organisateur: ' +
                                              snapshot.data[index].organisateur,
                                          style: TextStyle(fontSize: 15),
                                        )),
                                    Visibility(
                                    ...
                                    Visibility(
                                        visible:
                                        _coursBool(snapshot.data[index].type),
                                        child: Text(
                                          'Terrain: ' +
                                              snapshot.data[index].terrain,
                                          style: TextStyle(fontSize: 15),
                                        )),
                                    Visibility(
                                      visible:
